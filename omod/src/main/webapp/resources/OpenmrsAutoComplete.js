...
function CreateCallback(options) {
	...
	this.definitionCallback = function() { 
		var thisObject = this; 
		return function(q, response) {
			...
			DWRCohortBuilderService.getDefinitions(q, thisObject.makeRows(q, response, thisObject.searchCounter, thisObject.displayNamedObject));
		}
	}
